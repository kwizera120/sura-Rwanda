...
def get_housing_chatbot_response(message: str, history: list[dict] | None = None, property_context: dict | None = None) -> str:
    ...
    system_instruction = (
        ...
        "- Use **bold** for key terms like prices and locations.\n"
        "- If you are recommending a specific property, ALWAYS include a JSON block with property details at the end of your message using the tag [PROPERTY_DATA]...[/PROPERTY_DATA].\n"
        "- If the user asks for multiple houses, provide the data for the best match or the most recent one discussed.\n"
